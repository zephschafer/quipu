...
SELECT
  d.date
  , COALESCE(ibd.function_type, rbd.function_type) AS function_type
...
FULL JOIN reviews_by_day AS rbd ON d.date = rbd.date AND ibd.function_type = rbd.function_type
